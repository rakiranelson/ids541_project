...
\\caption{{Prediction gaps across low-access counties}}
\\end{{figure}}
...
As shown in Figure 4, Cherokee, Brunswick, Clay, Graham, and Ashe counties exhibit the largest negative prediction gaps. These counties should be prioritized for targeted intervention.

...
Across low-access counties, the average prediction gap is approximately \textbf{-0.07}, suggesting that observed distress generally aligns with expectations. However, this average masks important variation. A small number of counties -- Cherokee, Brunswick, Clay, Graham, and Ashe -- exhibit substantially negative prediction gaps, indicating that observed distress may underrepresent true need.
...
Among these counties, 4 are rural. They also exhibit higher unemployment (5.35\%) and higher uninsured rates (17.57\%), suggesting that structural barriers contribute both to underlying distress and to its underidentification.
